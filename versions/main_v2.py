...
from analysis_extract import EurofinsExtract, AgrolabExtract
...
# ======================================= UI 2 ==========================================
#
def ouvrir_ui_post_extract(matched_columns, extraction_type, excel_file, resultats_artelia, sheet_name):
    ...
    def extraire_en_excel():
        ...
        if extraction_type.lower() == "eurofins":
            from analysis_extract import EurofinsExtract
            extractor = EurofinsExtract(excel_file, temp_json, sheet_name)
            extractor.load_keywords()
            extractor.load_data()
            extractor.extract()
            extractor.export()
